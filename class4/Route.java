...
public class Route extends Thread {
    ...
    public Route(String TheardName, Socket socket, boolean clientSever, GUI gui) {
    ...
    public Route(String TheardName, Socket socket, boolean clientSever, int total, int number, int parameter) {
        this.TheardName = TheardName;
        this.socket = socket;
        this.clientSever = clientSever;
